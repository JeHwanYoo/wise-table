...
>(
  (
    ...
    const baseClasses =
      'inline-flex items-center justify-center font-medium rounded-md transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-900 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer disabled:cursor-not-allowed hover:scale-105 disabled:hover:scale-100 active:scale-95'
    ...
    const variantClasses = {
      ...
      ghost:
        'bg-transparent text-gray-600 hover:bg-gray-100 hover:text-gray-900 hover:shadow-sm focus:ring-gray-500 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white',
    }
