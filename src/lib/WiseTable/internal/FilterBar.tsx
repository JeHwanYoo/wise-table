  ...
  return (
    ...
    >
      <div className="flex flex-col space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            {activeFilters.map((activeFilter, index) => (
              <div
                ...
                className="inline-flex items-center px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm dark:bg-blue-900/30 dark:text-blue-200"
              >
        ...
        {hasUnsavedChanges() && (
          <div className="flex items-center gap-2 px-3 py-2 bg-yellow-100 border border-yellow-300 rounded-md text-sm text-yellow-800 dark:bg-yellow-900/20 dark:border-yellow-800 dark:text-yellow-300">
            <svg
